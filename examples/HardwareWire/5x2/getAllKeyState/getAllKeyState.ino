...
//  Выполняем действия по изменению состояния любой клавиши:        //
    ...
    i = kbd.getKey(KEY_ALL, KEY_STATE  );                           //   Получаем флаги текущего состояния кнопок.
        ...
        if(i & bit(4)){Serial.print("5,");}                         //   Если установлен 4 бит (флаг состояния 5 кнопки 1 ряда), то выводим текст.
        if(i & bit(5)){Serial.print("6,");}                         //   Если установлен 5 бит (флаг состояния 1 кнопки 2 ряда), то выводим текст.
        if(i & bit(6)){Serial.print("7,");}                         //   Если установлен 6 бит (флаг состояния 2 кнопки 2 ряда), то выводим текст.
        if(i & bit(7)){Serial.print("8,");}                         //   Если установлен 7 бит (флаг состояния 3 кнопки 2 ряда), то выводим текст.
        if(i & bit(8)){Serial.print("9,");}                         //   Если установлен 8 бит (флаг состояния 4 кнопки 2 ряда), то выводим текст.
        if(i & bit(9)){Serial.print("0,");}                         //   Если установлен 9 бит (флаг состояния 5 кнопки 2 ряда), то выводим текст.
        Serial.print("\r\n");                                       //
    }                                                               //
}                                                                   //
                                                                    //
